  ...
  const services = [
    {
      ...
      description: "Организуем приёмку, хранение и учёт товаров на современном складе. Чёткие процессы, автоматизация и контроль обеспечивают сохранность и быстрый доступ к каждой единице продукции.",
