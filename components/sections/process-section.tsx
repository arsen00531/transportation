      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Простой и понятный процесс от заявки до получения товара
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Закупка</h3>
            <p className="text-gray-600">Находим поставщиков и закупаем товары в Китае</p>
          </div>
          <div className="text-center">
            <div className="bg-yellow-400 text-gray-900 rounded-full w-16 h-16 flex items-center justify-center text-2xl font-bold mx-auto mb-4">
              3
            ...
            <p className="text-gray-600">Принимаем, проверяем и упаковываем на складе</p>
          </div>
          <div className="text-center">
            <div className="bg-yellow-400 text-gray-900 rounded-full w-16 h-16 flex items-center justify-center text-2xl font-bold mx-auto mb-4">
              4
